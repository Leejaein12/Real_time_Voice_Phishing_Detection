...
PHISHING_KEYWORDS: dict[str, list[str]] = {
    "기관사칭": [
        ...
        "지검", "공단",
        "수사과", "사무관", "조사관", "수사팀",          # 부서·직책
        "공문", "사건조회", "나의사건", "소환",           # 피싱 행위
        "검사님", "피의자", "사건번호", "조사",           # 수사 용어
        "녹취", "제3자",                                 # 고립·압박 유도
    ],
    "금전요구": [
    ...
    "개인정보": [
        ...
        "유출", "앞면",
        "실명인증", "실명확인", "본인확인",               # 신원 확인 유도
        "CVC", "유효기간", "카드뒷면",                   # 카드 정보 요구
        "명의", "분실",                                  # 명의도용 유도
    ],
    "기술적위협": [
    ...
    "심리적압박": [
        ...
        "연루", "소환장",
        "불법거래", "금융사기", "의심스러운",
        "이상거래", "보안조치", "계좌보호", "거래정지",  # 은행사칭 도입부 패턴
    ],
    "고립및기망": [
